...
#define MCCONF_L_BATTERY_CUT_START		24.0	// Start limiting the positive current at this voltage
#define MCCONF_L_BATTERY_CUT_END		24.0		// Limit the positive current completely at this voltage
...
// Setting limits
#define HW_LIM_CURRENT			-265.0, 265.0
